...
will be pretty ugly. However, Leyland gives you the ability to render
exceptions into views/templates, such that even exceptions can be returned
in the design and layout of your application.
...
In the future, I plan to have Leyland make it easier to globally set templates for
